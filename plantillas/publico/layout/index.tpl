...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="{$RUTA_WEB_ABSOLUTA}librerias/javascript/jquery/jquery.js" type="text/javascript"></script>
        <script src="{$RUTA_WEB_ABSOLUTA}librerias/javascript/jquery/validate/validate.js" type="text/javascript"></script>
        <script src="{$RUTA_WEB_ABSOLUTA}librerias/javascript/jquery/jquery-ui.min.js" type="text/javascript"></script>

		<!-- Javascripts necesarios para estilos en radio y checkbox. -->
		<script src="{$RUTA_WEB_ABSOLUTA}librerias/javascript/jquery/checkbox/customInput.jquery.js" type="text/javascript"></script>
		<script src="{$RUTA_WEB_ABSOLUTA}librerias/javascript/comunes.js" type="text/javascript"></script>
