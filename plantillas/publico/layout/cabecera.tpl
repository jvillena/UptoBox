  		...
  		<div class="container" style="width:980px">
				...
				<li {if isset($menu_principal) && $menu_principal=='colaboradores'}class="active"{/if}><a href="{$RUTA_WEB_ABSOLUTA}personal" {if isset($menu_principal) && $menu_principal=='colaboradores'}class="seleccionado"{/if}>{translate}tx_menu_colaboradores{/translate}</a></li>
					...
					<li class="dropdown" {if isset($menu_principal) && $menu_principal=='mi_cuenta'}class="active"{/if}>
						...
						<ul class="dropdown-menu">
							<li>
								<a class="azul" href="{$RUTA_WEB_ABSOLUTA}usuario/perfil">
									<div class="bd">
					        				<table>
					        					<tr>
					        						<td>
					        						{if $foto==""}
					        							<img style="border: 1px solid #CCC" src="{$RUTA_WEB_ABSOLUTA}librerias/php/rescalado_imagen/image.php/{$RUTA_WEB_ABSOLUTA}imagenes/iconos/icon_avatar_grande.png?width=30&amp;image={$RUTA_WEB_ABSOLUTA}imagenes/iconos/icon_avatar_grande.png"  alt="avatar-grande" />
					        						{else}
					        							<img style="border: 1px solid #CCC" src="{$RUTA_WEB_ABSOLUTA}librerias/php/rescalado_imagen/image.php/{$RUTA_WEB_ABSOLUTA}datos/usuarios/{$id_usuario}/perfil/{$foto}?width=30&amp;image={$RUTA_WEB_ABSOLUTA}datos/usuarios/{$id_usuario}/perfil/{$foto}"  alt="avatar-grande" />
					        						{/if}	
					        						</td>
					        						<td>
			...
			<ul class="nav secondary-nav" style="margin-right: 10px;">
           		<li class="menu" data-dropdown="menu">
           			...
           			<ul class="dropdown-menu">
							<li><a href="{$RUTA_WEB_ABSOLUTA}usuario/perfil">{translate}tx_menu_conf_perfil{/translate}</a></li>
							<li class="divider"></li>
			...
			<div class="wrapper-all">
		          	...
		          	<table class="page_table">
        					<tr>
        						...
        						<td style="width:22%; ">
        							{if $foto==""}
        							<img style="float:left;border: 1px solid #CCC;padding:4px;" src="{$RUTA_WEB_ABSOLUTA}librerias/php/rescalado_imagen/image.php/{$RUTA_WEB_ABSOLUTA}imagenes/iconos/icon_avatar_grande.png?width=40&amp;image={$RUTA_WEB_ABSOLUTA}imagenes/iconos/icon_avatar_grande.png"  alt="avatar-grande" />
	        						{else}
	        							<img style="float:left;border: 1px solid #CCC;padding:4px;" src="{$RUTA_WEB_ABSOLUTA}librerias/php/rescalado_imagen/image.php/{$RUTA_WEB_ABSOLUTA}datos/usuarios/{$id_usuario}/perfil/{$foto}?width=40&amp;image={$RUTA_WEB_ABSOLUTA}datos/usuarios/{$id_usuario}/perfil/{$foto}"  alt="avatar-grande" />
	        						{/if}	
