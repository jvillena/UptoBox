<?php 
require(BASE_PATH.'librerias/php/phpmailer/class.phpmailer.php');
class Notificacion{
	...
	function Notificacion(){
		...
		$this->mail->AddReplyTo("info@devuelvalo.com","devuelvalo.com");
		
		$this->mail->SetFrom("info@devuelvalo.com","devuelvalo.com");
	...
	function emailRegistro($id_usuario){
		...
		$this->mail->Subject    = "Activacion de usuario de devuelvalo.com";
	...
	function emailNuevaClave($id_usuario,$clave){
		...
		$this->mail->Subject    = "Recuperacion de su nueva clave en devuelvalo.com";
	...
	function emailMensajeEnviadoUsuario($id_usuario, $id_objeto){
		...
		$this->mail->Subject    = "Confirmacion de envio de mensaje en devuelvalo.com";
	...
	function emailMensajeRecibidoUsuario($id_usuario, $id_objeto){
		...
		$this->mail->Subject    = "Has recibido un nuevo mensaje en devuelvalo.com";
	...
	function emailSuscripcionCercaCaducidad($id_usuario,$fecha_fin){
		...
		$this->mail->Subject    = "devuelvalo.com - Suscripcion cerca de vencimiento.";
	...
	function emailSuscripcionCaducadas($id_usuario,$fecha_fin){
		...
		$this->mail->Subject    = "devuelvalo.com - Suscripcion expirada.";
	...
	function emailMensajeEnviadoNOUsuario($id_objeto, $datos){
		...
		$this->mail->AddAddress($datos['email'], "Usuario de devuelvalo.com");
		
		$this->mail->Subject    = "Has recibido un nuevo mensaje de un usuario de devuelvalo.com";
	...
	function emailMensajeContacto($nombre, $email, $telefono, $consulta) {
		...
		$this->mail->Subject = "Petición de contacto devuelvalo.com";
	...
	function emailMensajeTrabaja($nombre, $email, $telefono, $consulta, $archivo=0) {
		...
		$this->mail->Subject = "Peticion de trabajo en devuelvalo.com";
