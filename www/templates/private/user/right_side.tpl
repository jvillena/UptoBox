		...
		<ul class="lat_menu_navigation">
			...
			<li class="sistema expanded" style="text-align:left;">
        			...
        			<div class="bd" style="line-height: 12px;margin-left:10px;">
        				<ul> 
        				 <li>
        					 <img style="width:20px;vertical-align:bottom" src="{$BASE_THEMES_URL}images/icons/icon_folder.png"/>
        				 ...
        				 <li>
        				     <img style="width:20px;vertical-align:bottom" src="{$BASE_THEMES_URL}images/icons/icon_upload_file.png"/>
			...
			<li class="sistema expanded" style="text-align:left;">
        			...
        			<div class="bd" style="line-height: 12px;margin-left:10px;">
        				<ul> 
        				 	<li>
        				 	 	<img style="width:20px;vertical-align:bottom" src="{$BASE_THEMES_URL}images/icons/icon_perfil.png"/>
        				 	...
        				 	<li>
        				 		<img style="width:20px;vertical-align:bottom" src="{$BASE_THEMES_URL}images/icons/icon_almacenamiento.png"/>
        				...
        				<ul>
							...
							{/if}
        				 	...
        				 	<li>
       				     	...
       				     	<li>
        				 		<img style="width:20px;vertical-align:bottom" src="{$BASE_THEMES_URL}images/icons/icon_word.png"/>
        				 		<a class="azul" style="margin-bottom:10px;width:140px;clear:right;" href="{$RUTA_WEB_ABSOLUTA}almacenamiento">Manual PHP</a>
       				     	</li>
       				     	<li>
        				 		<img style="width:20px;vertical-align:bottom" src="{$BASE_THEMES_URL}images/icons/icon_pdf.png"/>
