...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script src="{$RUTA_WEB_ABSOLUTA}libs/javascript/bootstrap/bootstrap-popover.js" type="text/javascript"></script>
		<script src="{$RUTA_WEB_ABSOLUTA}libs/javascript/bootstrap/bootstrap-tabs.js" type="text/javascript"></script>
		<script src="{$RUTA_WEB_ABSOLUTA}libs/javascript/bootstrap/bootstrap-alerts.js" type="text/javascript"></script>
		
		<link href="{$RUTA_WEB_ABSOLUTA}libs/javascript/jquery/bubblePopup/jquery.bubblepopup.v2.3.1.css" rel="stylesheet" type="text/css">
		<script src="{$RUTA_WEB_ABSOLUTA}libs/javascript/jquery/bubblePopup/jquery.bubblepopup.v2.3.1.min.js" type="text/javascript"></script>
		...
		<link href="{$RUTA_WEB_ABSOLUTA}libs/javascript/jquery/upload/fileuploader.css" rel="stylesheet" type="text/css">
		<script src="{$RUTA_WEB_ABSOLUTA}libs/javascript/jquery/upload/fileuploader.js" type="text/javascript"></script>
