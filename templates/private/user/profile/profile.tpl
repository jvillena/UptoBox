	 ...
	 <div class="span3" style="margin-top:-15px;">
			<form id="form_upload_picture" name="form_upload_picture" method="post" action="{$RUTA_WEB_ABSOLUTA}user/profile/upload_picture"  enctype="multipart/form-data">
				...
				{if $datos_perfil.0.ruta_foto!=""}
					<img style="border: 1px solid #CCC" src="{$RUTA_WEB_ABSOLUTA}libs/php/rescalado_imagen/image.php/{$RUTA_WEB_ABSOLUTA}datas/users/{$datos_perfil.0.id_usuario}/profile/{$datos_perfil.0.ruta_foto}?height=150&amp;image={$RUTA_WEB_ABSOLUTA}datas/users/{$datos_perfil.0.id_usuario}/profile/{$datos_perfil.0.ruta_foto}"  alt="avatar-grande" />
				{else}
					<img style="border: 1px solid #CCC" src="{$RUTA_WEB_ABSOLUTA}libs/php/rescalado_imagen/image.php/{$RUTA_WEB_ABSOLUTA}images/icons/icon_avatar_grande.png?height=150&amp;image={$RUTA_WEB_ABSOLUTA}images/icons/icon_avatar_grande.png"  alt="avatar-grande" />
				{/if}	
